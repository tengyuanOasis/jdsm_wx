// 对小程序对应api进行封装，后续可快速编译为微信，支付宝小程序

module.exports = {
    canIUse: function canIUse(...args) {
        return my.canIUse(...args);
    },
    getSystemInfo: function getSystemInfo({ success, fail, complate }) {
    ...
    getStorageInfo: function getStorageInfo({ success, fail, complete }) {
    ...
    request: function request({ url, data, header, method, dataType, success, fail, complete }) {
        const requestObj = {
            url,
            headers: header,
            method,
    ...
    uploadFile: function uploadFile({ url, filePath, name, header, formData, success, fail, complete }) {
    ...
    downloadFile: function downloadFile({ url, header, success, fail, complete }) {
    ...
    saveImageToPhotosAlbum: function saveImageToPhotosAlbum({ filePath, success, fail, complete }) {
        return my.saveImage({
            url: filePath,
            success,
            fail,
    ...
    showToast: function ({ title, icon, duration, success, fail, complete }) {
        return my.showToast({
            content: title,
            type: icon,
            duration,
    ...
    showModal: function showModal({ title, content, cancelText, confirmText, success, fail, complete }) {
        return my.confirm({
            title,
            content,
    ...
    showLoading: function showLoading({ title, success, fail, complete }) {
    ...
    showActionSheet: function showActionSheet({ itemList, success, fail, complete }) {
    ...
    setNavigationBarTitle: function setNavigationBarTitle({ title, success, fail, complete }) {
    ...
    setNavigationBarColor: function setNavigationBarColor({ backgroundColor, success, fail, complete }) {
        return my.setNavigationBar({
            backgroundColor,
            success,
            fail,
    ...
    pageScrollTo: function pageScrollTo({ scrollTop }) {
        return my.pageScrollTo({
            scrollTop
        });
    },
    createAnimation: function createAnimation({ duration, timingFunction, delay, transformOrigin }) {
    ...
    stopAccelerometer: function stopAccelerometer({ succss, fail, complete }) {
    ...
    stopBluetoothDevicesDiscovery: function stopBluetoothDevicesDiscovery({ success, fail, complete }) {
    ...
    startBluetoothDevicesDiscovery: function startBluetoothDevicesDiscovery({ services, allowDuplicatesKey, interval, success, fail, complete }) {
    ...
    openBluetoothAdapter: function openBluetoothAdapter({ success, fail, complete }) {
    ...
    getConnectedBluetoothDevices: function getConnectedBluetoothDevices({ services, success, fail, complete }) {
    ...
    getBluetoothDevices: function getBluetoothDevices({ success, fail, complete }) {
    ...
    getBluetoothAdapterState: function getBluetoothAdapterState({ success, fail, complete }) {
    ...
    closeBluetoothAdapter: function closeBluetoothAdapter({ success, fail, complete }) {
    ...
    readBLECharacteristicValue: function readBLECharacteristicValue({ deviceId, serviceId, characteristicId, success, fail, complete }) {
    ...
    notifyBLECharacteristicValueChange: function notifyBLECharacteristicValueChange({ deviceId, serviceId, characteristicId, state, success, fail, complete }) {
    ...
    getBLEDeviceServices: function getBLEDeviceServices({ deviceId, success, fail, complete }) {
    ...
    getBLEDeviceCharacteristics: function getBLEDeviceCharacteristics({ deviceId, serviceId, success, fail, complete }) {
    ...
    createBLEConnection: function createBLEConnection({ deviceId, success, fail, complete }) {
    ...
    closeBLEConnection: function closeBLEConnection({ deviceId, success, fail, complete }) {
    ...
    writeBLECharacteristicValue: function writeBLECharacteristicValue({ deviceId, serviceId, characteristicId, value, success, fail, complete }) {
    ...
    setClipboard: function ({ text, success, fail, complete }) {
    ...
    getClipboardData: function ({ success, fail, complete }) {
    ...
    stopCompass: function ({ succss, fail, complete }) {
    ...
    stopGyroscope: function stopGyroscope({ succss, fail, complete }) {
    ...
    startBeaconDiscovery: function startBeaconDiscovery({ uuids, success, fail, complete }) {
    ...
    stopBeaconDiscovery: function stopBeaconDiscovery({ success, fail, complete }) {
    ...
    getBeacons: function getBeacons({ success, fail, complete }) {
    ...
    getNetworkType: function getNetworkType({ success, fail, complete }) {
    ...
    makePhoneCall: function makePhoneCall({ phoneNumber, success, fail, complete }) {
    ...
    scanCode: function scanCode({ onlyFromCamera = false, scanType = ['barCode', 'qrCode'], success, fail, complete }) {
        let type = 'qr';
    ...
    setScreenBrightness: function setScreenBrightness({ value, success, fail, complete }) {
    ...
    setKeepScreenOn: function setKeepScreenOn({ keepScreenOn, success, fail, complete }) {
    ...
    getScreenBrightness: function getScreenBrightness({ success, fail, complete }) {
    ...
    saveFile: function saveFile({ tempFilePath, success, fail, complete }) {
        return my.saveFile({
    ...
    getFileInfo: function getFileInfo({ filePath, digestAlgorithm, success, fail, complete }) {
    ...
    getSavedFileInfo: function getSavedFileInfo({ filePath, success, fail, complete }) {
    ...
    getSavedFileList: function getSavedFileList({ success, fail, complete }) {
    ...
    removeSavedFile: function removeSavedFile({ filePath, success, fail, complete }) {
    ...
    openSetting: function openSetting({ success = noop, fail, complete }) {
    ...
    getSetting: function getSetting({ success = noop, fail, complete }) {
    ...
    getLocation: function getLocation({ type, altitude, success, fail, complete }) {
        if (altitude) {
