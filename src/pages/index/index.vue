    ...
    <view style="height: 100%">
        ...
        <view class="con">
            ...
            <view class="searchctl" @tap="toKeySearch">
                <image src="/static/images/l_search.png" style="width: 30rpx; height: 30rpx; margin-left: 36rpx; margin-right: 20rpx"></image>
                <text>点击快速搜索机型</text>
            </view>
            <view class="con-list">
                <view class="con-list-left">
                    <image src="/static/images/yj.png" style="width: 10rpx; height: 36rpx"></image>
                    <text>回收品牌</text>
                </view>
            ...
            <!-- 品牌 -->
            <view class="brandctl" v-if="brandList.length > 0">
                <block v-for="(item, index) in brandList" :key="index">
                    <view class="b-item" v-if="index < 5" :data-brand-id="item.brandId" @tap="toCategoryFun">
                        <image :src="domainName + item.img" style="width: 100rpx; height: 100rpx"></image>
                        <text>{{ item.brandName }}</text>
                    </view>

                    <view class="b-item" v-if="index == 5" data-brand-id="" @tap="toCategoryFun">
                        <image src="/static/images/more_brand.jpg" style="width: 90rpx; height: 90rpx; margin-top: 10rpx; margin-bottom: 10rpx"></image>
                        <text>更多</text>
                    </view>
                </block>
            </view>
            <view class="brandctl" v-else>暂无分类~</view>
        </view>

        <!-- 机型识别 wx:if="{{phoneName}}" -->
        <view class="con" v-if="phoneName" style="position: relative; overflow: hidden; height: 400rpx">
        ...
        <view class="con" style="position: relative; overflow: hidden; height: 290rpx">
            ...
            <view class="con-list-right" style="position: absolute; top: 41rpx; z-index: 2; right: 0" @tap="toCommonProblem">
                <text style="font-size: 30rpx; color: #f271a3; font-weight: bold">问题汇总</text>
            </view>

            <view class="processctl">
                <view class="c-item">
                    <image src="/static/images/process/search.png" style="width: 56rpx; height: 56rpx"></image>
                    <text>选择机型</text>
                </view>

                <view class="c-item">
                    <image src="/static/images/process/price.png" style="width: 56rpx; height: 56rpx"></image>
                    <text>免费估价</text>
                </view>

                <view class="c-item">
                    <image src="/static/images/process/order.png" style="width: 56rpx; height: 56rpx"></image>
                    <text>下单发货</text>
                </view>

                <view class="c-item">
                    <image src="/static/images/process/pay.png" style="width: 56rpx; height: 56rpx"></image>
                    <text>验货打款</text>
                </view>
            </view>
        </view>
                            ...
                            for (let v = 0; v < newArray.length; v++) {
                                if (newArray[v].name == formatKey) {
                                    that.setData({
                                        ...
                                        versionImg: that.domainName + '/GetFile/getUploadImg?fileName=' + newArray[v].title_img,
