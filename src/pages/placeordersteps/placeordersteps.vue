    ...
    <view style="height: 100%">
        ...
        <view class="container">
                    ...
                    <view class="feature-child-box">
                        <view
                            ...
                            :class="
                                ...
                                N +
                                ' ' +
                                (dataTemps[Tool.backStr(M, 1)][N][8] ? 'isConflict' : '') +
                                ' feature-child ' +
                                (dataTemps[Tool.backStr(M, 1)][N][1] ? 'count-select' : '')
                            "
            ...
            <view class="modalBox" v-if="showModal">
                ...
                <image @tap="closeModal" mode="aspectFit" class="outImg" src="/static/pages/placeordersteps/images/out.png" />
...
export default {
    ...
    methods: {
                ...
                success: function (res) {
                    if (res.statusCode === 200) {
                        if (res.data.status === 200) {
                            ...
                            let features_optionsEx = that.copyObj(features_options);
        ...
        showNextfeature: function (event) {
            ...
            let currentPressId = event.currentTarget.dataset.optionid;
            let currentParentId = event.currentTarget.dataset.parentfeatureid; //取出键和值
        ...
        toPricePage: function () {
            ...
            if (that.product_title.type_name == 'phone' && specialOption && area_sum3 != undefined && area_sum3 != 0) {
                    ...
                    if (res.statusCode === 200) {
                        ...
                        if (
                            ...
                            if (global_markup_money != 0) {
                                ...
                                //修改加价券相关信息
                                that.product_title.markup_money = global_markup_money + that.product_title.markup_money; //更换加价券金额
                                that.product_title.mrremark = '范围加价：' + global_markup_money + ' ；机型加价：' + that.product_title.markup_money; //加价备注
                            } else {
                                //下单传老价格参数
                                final_price += that.product_title.markup_money;
                        ...
                        if (isLock & (that.product_title.type_name == 'phone') & (that.product_title.brand_name == '苹果') & (that.product_title.lock_money > 0)) {
                            ...
                            that.product_title.mrremark += ' iphone有锁机加价：' + that.product_title.lock_money;
                        }
                        uni.setStorage({
                            key: 'final_price',
                            data: final_price
        ...
        isLockFun: function (arrays) {
            let temp = this.features_options; //所有选项合集
